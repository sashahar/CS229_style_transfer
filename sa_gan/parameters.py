...
def get_parameters():
    ...
    parser.add_argument('--adv_loss', type=str, default='hinge', choices=['wgan-gp', 'hinge', 'softmax'])
    ...
    parser.add_argument('--conv_G', type=str2bool, default=False)
    ...
    parser.add_argument('--dataset', type=str, default='cifar', choices=['lsun', 'celeb', 'coil-15'])
